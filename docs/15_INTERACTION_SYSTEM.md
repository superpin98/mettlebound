...
## Apéndice A: Estado del catálogo Parte A

Tabla generada al cierre de Parte A. Las 34 entradas corresponden a las 31 categorías del índice original (la categoría 9 está dividida en 9a/9b/9c/9d en el JSON).

| # | Categoría | category_id | Vectores | Estado |
|---|-----------|-------------|:---:|:---:|
...
| 9a | Daño elemental — Tierra / Sísmico | elemental_earth | 6 | ✅ Poblado |
...
**Total: 34 categorías, 434 vectores.**
